...
export default function Name(): JSX.Element {
  ...
  return (
    <form
      className="flex flex-col items-center w-full max-w-lg px-4 space-y-4 text-sm text-left md:text-base md:space-y-8"
    ...
    >
      ...
      <div className="flex">
        <Input
          className="p-2 transition duration-300 ease-in-out bg-transparent border-2 border-gray-600 rounded shadow-sm hover:border-purple-800 focus:border-purple-800 focus:outline-none focus:ring-1 ring-purple-400 disabled:bg-gray-100 disabled:text-gray-900 disabled:cursor-not-allowed"
          id="name"
          name="name"
